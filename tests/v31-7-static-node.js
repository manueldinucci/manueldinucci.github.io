...
ok(app.includes('<summary class="rose-manager-head"><strong>${esc(manager.nome)}</strong><b>${displayNum(stats.budgetRemaining)} cr</b></summary>'), 'Rose header must contain only name and remaining credits');
